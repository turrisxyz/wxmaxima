...
{
public:
  DigitCell(const GroupCell *group, Configuration **config, const wxString &text = {}, TextStyle style = TS_NUMBER);
  DigitCell(const GroupCell *group, const DigitCell &cell);
  ~DigitCell(){}
