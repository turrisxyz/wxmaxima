  ...
  m_worksheet(worksheet)
{
  ...
  wxString fontDisclaimer = _("\n might not be available in all fonts");
  const CharButton::Definition symbolButtonDefinitions[] = {
    ...
    {L'\u2148'}, _("A double-barred i") + fontDisclaimer,
    {L'\u2147'}, _("A double-barred e") + fontDisclaimer,
    {L'\u210F'}, _("The heisenberg constant hbar sign, slanted") + fontDisclaimer,
    {L'\u2208', _("in") + fontDisclaimer},
    {L'\u2203', _("exists") + fontDisclaimer},
    {L'\u2204', _("there is no") + fontDisclaimer},
    {L'\u21D2', _("\"implies\" symbol") + fontDisclaimer, true},
    {L'\u221E', _("Infinity") + fontDisclaimer, true},
    {L'\u2205', _("empty") + fontDisclaimer},
    {L'\u25b6'}, _("Big arrowhead facing right") + fontDisclaimer,
    {L'\u25b8'}, _("Small arrowhead facing right") + fontDisclaimer,
    {L'\u22C0', _("and") + fontDisclaimer, true},
    {L'\u22C1', _("or") + fontDisclaimer, true},
    {L'\u22BB', _("xor") + fontDisclaimer, true},
    {L'\u22BC', _("nand") + fontDisclaimer, true},
    {L'\u22BD', _("nor") + fontDisclaimer, true},
    {L'\u21D4', _("equivalent") + fontDisclaimer, true},
    {L'\u00b1', _("plus or minus")},
    {L'\u00AC', _("not") + fontDisclaimer, true},
    {L'\u22C3', _("union") + fontDisclaimer},
    {L'\u22C2', _("intersection") + fontDisclaimer},
    {L'\u2286', _("subset or equal") + fontDisclaimer},
    {L'\u2282', _("subset") + fontDisclaimer},
    {L'\u2288', _("not subset or equal") + fontDisclaimer},
    {L'\u2284', _("not subset") + fontDisclaimer},
    {L'\u0127'}, _("The heisenberg constant hbar sign") + fontDisclaimer,
    {L'\u0126'}, _("The heisenberg constant hbar sign, capital letter") + fontDisclaimer,
    {L'\u2202', _("partial sign") + fontDisclaimer},
    {L'\u2207', _("nabla sign") + fontDisclaimer},
    {L'\u222b', _("Integral sign") + fontDisclaimer},
    {L'\u2245'}, _("approximately proportional sign"),
    {L'\u221d', _("proportional to") + fontDisclaimer},
    {L'\u2260', _("not bytewise identical") + fontDisclaimer, true},
    {L'\u2264', _("less or equal"), true},
    {L'\u2265', _("greater than or equal"), true},
    {L'\u226A', _("much less than") + fontDisclaimer},
    {L'\u226B', _("much greater than") + fontDisclaimer},
    {L'\u2263', _("Identical to") + fontDisclaimer},
    {L'\u2211', _("Sum sign") + fontDisclaimer},
    {L'\u220F', _("Product sign") + fontDisclaimer},
    {L'\u2225', _("Parallel to")},
    {L'\u27C2', _("Perpendicular to")},
    {L'\u219D', _("Leads to")},
    {L'\u2192', _("Right arrow")},
    {L'\u27F6', _("Long Right arrow")},
    {L'\u220e', _("End of proof") + fontDisclaimer},
  };
